...
from legged_gym.envs.adam.adam import AdamRobot
from legged_gym.envs.adam.adam_config import AdamCfg, AdamCfgPPO
...
task_registry.register( "adam", AdamRobot, AdamCfg(), AdamCfgPPO())
